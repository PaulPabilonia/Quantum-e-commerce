...
SECRET_KEY = 'django-insecure-&hcv#+_u*tgsq6&hb(=kdt&6a^9vj)mp*@#=if#dp5@oefp&)6'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'quantumtechcompanyy@gmail.com'
EMAIL_HOST_PASSWORD = 'jibmiilmfibhgweu'
